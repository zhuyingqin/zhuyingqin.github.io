/**
 *
 * axis41-core - JavaScript/jQuery Functions
 *
 **/
(function($) {

	$(".search-bar .input-group-addon").click(function(e) {
        var srchForm = $(this).closest('form');
        srchForm.submit();
        var inputQ = $(e).parent().find("#q");
        if (inputQ.val() == '') {
            inputQ.val('');
            inputQ.focus();
        }
    ...
    $("#noResultRedirect").click(function() {
        $("#q").val('');
        $('#q').focus();
    });
    /**
    ...
    $(".utilitylinks").each(function() {
        var id = $(this).attr("id");
        var anccolor = $(this).find("li").css("color");
        $(this).find("li a ").css("color", anccolor);
	});
...
(function($) {
    /**
     * Extension of Data Table for Pagination - Start
     * 
     */
    $(".tables").each(function() {
        var tableId = $(this).attr("id");
        /**
         * The following code will apply to default table for pagination and etc . 
         * Table id should starts with 'defaultTable-'
         */
        if (tableId != null && tableId != '' && tableId.includes('defaultTable-') ) {

            var paging = $('#paging').val();
            paging = returnBoolean(paging);
            var ordering = $('#ordering').val();
            ordering = returnBoolean(ordering);
            var info = $('#info').val();
            info = returnBoolean(info);
            var bFilter = $('#bFilter').val();
            bFilter = returnBoolean(bFilter);
            var bLengthChange = $('#bLengthChange').val();
            bLengthChange = returnBoolean(bLengthChange);
            var orderMulti = $('#orderMulti').val();
            orderMulti = returnBoolean(orderMulti);
            var pageLength = $('#pageLength').val();
            var pagelimitvalue = parseInt(pageLength);

            /* Declaration  of table pagination*/
            var table = $('#' + tableId + '> table').DataTable({
                ...
                "language": {
                    ...
                    "info": "Showing _START_ to _END_ of _TOTAL_ chapters",
                    "infoEmpty": "Showing 0 to 0 of 0 chapters",
                    "infoFiltered": "(filtered from _MAX_ total chapters)",
                    "infoPostFix": "",
                    "thousands": ",",
            ...
            table.page.len(pagelimitvalue).draw();

            /**
             * Extension of Data Table for Pagination - End
             */
            function returnBoolean(custSting) {
                if (custSting == "true") {
                    return true;
                } else {
                    return false;
...
/**
 * Bright cove video version
 */
$(document).ready(function() {
    function init() {
        if ($('html').find('.modal').length < 1) {
            $('.img-vid-content').removeClass('add-cursor');
        }
    }
    init();
});

function loadVideoJsPlugins() {
    videojs.plugin('horizontalVolume', function() {
        var myPlayer = this,
            control_bar = myPlayer.controlBar,
            vmb = control_bar.volumeMenuButton;
        control_bar.removeChild('VolumeControl');
        control_bar.removeChild('MuteToggle');
        control_bar.addChild('VolumeControl');
        control_bar.addChild('MuteToggle');
        control_bar.removeChild(vmb);
    });
    $('video').each(function() {
        var vidElemVal = $(this).attr('id');
        videojs(vidElemVal).horizontalVolume();
    })
}
/**
 * Bright cove video play based given video ID
 * Param : val
 */
function changeVideo(val) {
    var videoId = $(val).attr('vid-id');
    var selectedModel = $(val).attr('data-target');
    var videoElem = $(selectedModel).find('video').attr('id');
    if (videoElem == null || videoElem == undefined) {
        videoElem = $(selectedModel).find('.video-js').attr('id');
    }
    var bcVideoPlayer;
    loadVideoJsPlugins();
    videojs(videoElem).ready(function() {
        bcVideoPlayer = this;
        bcVideoPlayer.play();
        bcVideoPlayer.catalog.getVideo(videoId, function(error, video) {
            bcVideoPlayer.catalog.load(video);
            bcVideoPlayer.play();
        });
        $('.video-js').on('click', function(e) {
            e.stopPropagation();
        });
        $('.modal.modal-close').on('click', function(e) { // modal close
            bcVideoPlayer.pause();
        });
        $(document).keyup(function(e) {
            if (e.keyCode === 27) $('.modal.modal-close').trigger('click'); // esc key - modal close
        });
    });
}
/**
...
! function(e) {
    ...
    SEMICOLON.initialize = {
        ...
        responsiveClasses: function() {
            if ("undefined" == typeof jRespond) return "responsiveClasses: jRespond not Defined.", !0;
            var e = jRespond([{
                label: "smallest",
                enter: 0,
                exit: 479
        ...
        lightbox: function() {
            if (!e().magnificPopup) return "lightbox: Magnific Popup not Defined.", !0;
        ...
        modal: function() {
            if (!e().magnificPopup) return "modal: Magnific Popup not Defined.", !0;
        ...
        resizeVideos: function() {
            return e().fitVids ? void e("#content,#footer,#slider:not(.revslider-wrap),.landing-offer-media,.portfolio-ajax-modal,.mega-menu-column").fitVids({
                ...
                ignore: ".no-fv"
            }) : ("resizeVideos: FitVids not Defined.", !0)
        },
        imageFade: function() {
        ...
        pageTransition: function() {
            ...
            if (!e().animsition) return a.addClass("no-transition"), "pageTransition: Animsition not Defined.", !0;
        ...
        setFullColumnWidth: function(t) {
            if (!e().isotope) return "setFullColumnWidth: Isotope not Defined.", !0;
            if (t.css({
                    width: ""
        ...
        superfish: function() {
            return (a.hasClass("device-lg") || a.hasClass("device-md")) && (e("#primary-menu ul ul, #primary-menu ul .mega-menu-content").css("display", "block"), SEMICOLON.header.menuInvert(), e("#primary-menu ul ul, #primary-menu ul .mega-menu-content").css("display", "")), e().superfish ? (e("body:not(.side-header) #primary-menu > ul, body:not(.side-header) #primary-menu > div > ul:not(.dropdown-menu), .top-links > ul").superfish({
                ...
                cssArrows: !1
            })) : (a.addClass("no-superfish"), "superfish: Superfish not Defined.", !0)
        },
        menuInvert: function() {
        ...
        menufunctions: function() {
            ...
            }), SEMICOLON.isMobile.Windows() && (e().superfish ? e("#primary-menu > ul, #primary-menu > div > ul,.top-links > ul").superfish("destroy").addClass("windows-mobile-menu") : (e("#primary-menu > ul, #primary-menu > div > ul,.top-links > ul").addClass("windows-mobile-menu"), "menufunctions: Superfish not defined."), e("#primary-menu ul li:has(ul)").append('<a href="#" class="wn-submenu-trigger"><i class="icon-angle-down"></i></a>'), e("#primary-menu ul li.sub-menu").children("a.wn-submenu-trigger").click(function(t) {
        ...
        sliderRun: function() {
            if ("undefined" == typeof Swiper) return "sliderRun: Swiper not Defined.", !0;
        ...
        parallax: function() {
            return e.stellar ? void((J.length > 0 || X.length > 0 || K.length > 0) && (SEMICOLON.isMobile.any() ? (J.addClass("mobile-parallax"), X.addClass("mobile-parallax"), K.addClass("mobile-parallax")) : e.stellar({
                ...
                verticalOffset: 150
            }))) : ("parallax: Stellar not Defined.", !0)
        },
        animations: function() {
            if (!e().appear) return "animations: Appear not Defined.", !0;
        ...
        loadFlexSlider: function() {
            if (!e().flexslider) return "loadFlexSlider: FlexSlider not Defined.", !0;
            ...
            t.length > 0 && t.each(function() {
                ...
                a || (a = "slide"), i && "swing" != i || (i = "swing", g = !0), s || (s = "horizontal"), n = "true" == n ? !0 : !1, o = o ? !1 : !0, r || (r = 5e3), l || (l = 600), d || (d = !1), m = "false" == m ? !1 : !0, "vertical" == s && (m = !1), c = "false" == c ? !1 : !0, c = "true" == h ? "thumbnails" : c, u = "false" == u ? !1 : !0, f = "false" == f ? !1 : !0, p = "false" == p ? !1 : !0, t.flexslider({
                    ...
                    start: function(t) {
                        ...
                        SEMICOLON.initialize.lightbox(), e(".flex-prev").html('<i class="glyphicon glyphicon-chevron-left"></i>'), e(".flex-next").html('<i class="glyphicon glyphicon-chevron-right"></i>'), SEMICOLON.portfolio.portfolioDescMargin()
                    },
                    after: function() {
        ...
        youtubeBgVideo: function() {
            if (!e().mb_YTPlayer) return "youtubeBgVideo: YoutubeBG Plugin not Defined.", !0;
        ...
        tabs: function() {
            if (!e().tabs) return "tabs: Tabs not Defined.", !0;
        ...
        counter: function() {
            if (!e().appear) return "counter: Appear not Defined.", !0;
            if (!e().countTo) return "counter: countTo not Defined.", !0;
        ...
        roundedSkill: function() {
            if (!e().appear) return "roundedSkill: Appear not Defined.", !0;
            if (!e().easyPieChart) return "roundedSkill: EasyPieChart not Defined.", !0;
        ...
        progress: function() {
            if (!e().appear) return "progress: Appear not Defined.", !0;
            var t = e(".progress");
            t.length > 0 && t.each(function() {
                var t = e(this),
                    i = t.parent("li"),
        ...
        twitterFeed: function() {
            if ("undefined" == typeof sm_format_twitter) return "twitterFeed: sm_format_twitter() not Defined.", !0;
        ...
        flickrFeed: function() {
            if (!e().jflickrfeed) return "flickrFeed: jflickrfeed not Defined.", !0;
            var t = e(".flickr-feed");
            t.length > 0 && t.each(function() {
                var t = e(this),
                    a = t.attr("data-id"),
        ...
        instagramPhotos: function(t, a) {
            if ("undefined" == typeof Instafeed) return "Instafeed not Defined.", !0;
        ...
        dribbbleShots: function(t) {
            if (!e.jribbble) return "dribbbleShots: Jribbble not Defined.", !0;
            if (!e().imagesLoaded) return "dribbbleShots: imagesLoaded not Defined.", !0;
        ...
        carousel: function() {
            if (!e().owlCarousel) return "carousel: Owl Carousel not Defined.", !0;
        ...
        masonryThumbsArrange: function(t) {
            return e().isotope ? (SEMICOLON.initialize.setFullColumnWidth(t), void t.isotope("layout")) : ("masonryThumbsArrange: Isotope not Defined.", !0)
        },
        notifications: function(t) {
            if ("undefined" == typeof toastr) return "notifications: Toastr not Defined.", !0;
            toastr.remove();
            var a = e(t),
        ...
        contactForm: function() {
            if (!e().validate) return "contactForm: Form Validate not Defined.", !0;
            if (!e().ajaxSubmit) return "contactForm: jQuery Form not Defined.", !0;
        ...
        subscription: function() {
            if (!e().validate) return "subscription: Form Validate not Defined.", !0;
            if (!e().ajaxSubmit) return "subscription: jQuery Form not Defined.", !0;
        ...
        quickContact: function() {
            if (!e().validate) return "quickContact: Form Validate not Defined.", !0;
            if (!e().ajaxSubmit) return "quickContact: jQuery Form not Defined.", !0;
        ...
        stickySidebar: function() {
            if (!e().scwStickySidebar) return "stickySidebar: Sticky Sidebar is not Defined.", !0;
        ...
        cookieNotify: function() {
            if (!e.cookie) return "cookieNotify: Cookie Function not defined.", !0;
            if (ee.length > 0) {
        ...
        extras: function() {
            e().tooltip ? e('[data-toggle="tooltip"]').tooltip({
                container: "body"
            }) : "extras: Bootstrap Tooltip not defined.", e().popover ? e("[data-toggle=popover]").popover() : "extras: Bootstrap Popover not defined.", e(".style-msg").on("click", ".close", function(t) {
        ...
        init: function() {
            setTimeout(function() {
                SEMICOLON.header.topsocial(), SEMICOLON.header.fullWidthMenu(), SEMICOLON.header.overlayMenu(), SEMICOLON.initialize.fullScreen(), SEMICOLON.initialize.verticalMiddle(), SEMICOLON.initialize.maxHeight(), SEMICOLON.initialize.testimonialsGrid(), SEMICOLON.initialize.stickyFooter(), SEMICOLON.slider.sliderParallaxDimensions(), SEMICOLON.slider.captionPosition(), SEMICOLON.portfolio.arrange(), SEMICOLON.portfolio.portfolioDescMargin(), SEMICOLON.widget.tabsResponsiveResize(), SEMICOLON.widget.tabsJustify(), SEMICOLON.widget.html5Video(), SEMICOLON.widget.masonryThumbs(), SEMICOLON.initialize.dataResponsiveClasses(), SEMICOLON.initialize.dataResponsiveHeights(), M.length > 0 && (M.hasClass(".customjs") || (e().isotope ? M.isotope("layout") : "documentOnResize > init: Isotope not defined.")), (a.hasClass("device-lg") || a.hasClass("device-md")) && e("#primary-menu").find("ul.mobile-primary-menu").removeClass("show")
            }, 500);
            l = t.width()
        }
...
/**
 *
 * axis41-core - Google-Maps Functions
 *
 **/
function initMap() {
    $('#geoMetricPanel').hide();
    ...
    if ($("#leftMapContainer").length > 0) {
        var leftMapContainer = new google.maps.Map(document.getElementById('leftMapContainer'), {
            zoom: 8,
            scrollwheel: false,
            center: leftMapGeo
        });
        var markerLeftMap = new google.maps.Marker({
            position: leftMapGeo,
            map: leftMapContainer
        });
    }
    //Right Map Init
    var rightMapGeo = {
    ...
    if ($("#rightMapContainer").length > 0) {
        var rightMapContainer = new google.maps.Map(document.getElementById('rightMapContainer'), {
            zoom: 8,
            scrollwheel: false,
            center: rightMapGeo
        });
        var markerRightMap = new google.maps.Marker({
            position: rightMapGeo,
            map: rightMapContainer
        });
    }
    //Container WidthMap Init
    var containerMapGeo = {
        lat: 48.856614,
        lng: 2.3522219000000177
    };
    if ($("#containerMap").length > 0) {
        var containerMap = new google.maps.Map(document.getElementById('containerMap'), {
            zoom: 8,
            scrollwheel: false,
            center: containerMapGeo
        });
        var markerContainerMap = new google.maps.Marker({
            position: containerMapGeo,
            map: containerMap
        });
    }
    if (!!navigator.geolocation && $("#google_canvas").length > 0) {
        var map;
        var mapOptions = {
            zoom: 15,
        ...
        navigator.geolocation.getCurrentPosition(function(position) {
            ...
            var infowindow = new google.maps.InfoWindow({
                map: map,
                position: geolocate,
                content: '<h1>Geolocation!</h1>' + '<h2>Latitude: ' + position.coords.latitude + '</h2>' + '<h2>Longitude: ' + position.coords.longitude + '</h2>'
            });
    ...
    if ($("#customMap").length > 0) {
        var customMap = new google.maps.Map(document.getElementById('customMap'), {
            zoom: 8,
            scrollwheel: false,
            center: {
                lat: -34.397,
        ...
        autocomplete.bindTo('bounds', customMap);
        autocomplete.addListener('place_changed', function() {
            ...
            if (place.geometry.viewport) {
                customMap.fitBounds(place.geometry.viewport);
            } else {
                customMap.setCenter(place.geometry.location);
                customMap.setZoom(17); // Why 17? Because it looks good.
            }
